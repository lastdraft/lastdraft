            ...
            ->children()
                ->arrayNode('author')
                    ...
                    ->children()
                        ->scalarNode('model')
                            ->cannotBeEmpty()
                            ->example('Lastdraft\\Bundle\\PostBundle\\Model\\Author')
                            ->info('Post Model Class')
                            ->defaultValue('Lastdraft\\Bundle\\PostBundle\\Model\\Author')
                        ->end()
                ...
                ->arrayNode('post')
                    ...
                    ->children()
                        ->scalarNode('model')
                            ->cannotBeEmpty()
                            ->example('Lastdraft\\Bundle\\PostBundle\\Model\\Post')
                            ->info('Post Model Class')
                            ->defaultValue('Lastdraft\\Bundle\\PostBundle\\Model\\Post')
                        ->end()
